...
public:
    ...
    virtual bool within( Point3D point, const Matrix4x4 worldToModel) = 0;
};
...
public:
    ...
    bool within( Point3D point, const Matrix4x4 worldToModel);
};
...
// Unit cone with radius 1 and height 1 along the y axis, with tip
// at origin.
